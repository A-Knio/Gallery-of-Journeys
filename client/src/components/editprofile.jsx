    ...
    <div className="mt-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea id="bio" placeholder={user.bio} type="text" value={bio} onChange={handleBioChange} className="mt-1 py-1 inline-block border px-2  focus:ring-indigo-500 focus:border-indigo-500  w-full h-24 overscroll-none shadow-sm sm:text-sm  border-gray-300 rounded-md" />
        </div>
        <div>
